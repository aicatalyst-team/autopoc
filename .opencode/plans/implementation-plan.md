...
| **16. Vale Prose Linting** | 15.1–15.6 | Post-generation Vale lint + LLM revision loop for markdown artifacts. See [vale-linting-plan.md](./vale-linting-plan.md) |
...
| **16. Vale Prose Linting** | **PLANNING** | 0/6 | -- |
